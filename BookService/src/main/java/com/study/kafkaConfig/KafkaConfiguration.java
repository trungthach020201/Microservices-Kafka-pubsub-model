...
public class KafkaConfiguration {
    ...
    public Map<String, Object> consumerConfig() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, BorrowEvent.class); // Specify the expected value type
        return props;
    }
...
//        consumerFactory.setErrorHandler(new SeekToCurrentErrorHandler());
